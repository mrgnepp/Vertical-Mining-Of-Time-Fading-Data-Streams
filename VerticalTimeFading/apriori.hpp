...
std::map< std::set< int >, double, cmp_by_cardinality > clean_frequent_itemsets( std::map< std::set< int >, double, cmp_by_cardinality > candidates, double minsup );
...
std::map< std::set< int >, double, cmp_by_cardinality > fade_itemsets( std::map< std::set< int >, double, cmp_by_cardinality > freq_itemsets, double fade_factor );
std::map< std::set< int >, double, cmp_by_cardinality > count_singletons( std::vector< transaction > transactions );
...
std::map< std::set< int >, double, cmp_by_cardinality > count_itemsets( std::vector< apriori::transaction > transactions, std::map< std::set< int >, double, cmp_by_cardinality > candidate_itemsets ) ;
